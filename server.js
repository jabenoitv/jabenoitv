...
const server = http.createServer((req, res) => {
  ...
  if (url === '/siwn') {
    const handleSiwn = (signerUuid, fid, username) => {
      ...
      saveState();
      console.log('[FARCASTER] *** SIGNER UUID (agrega a Railway env vars) ***');
